...
\end{equation}
So the bosonic three-tachyon sector now matches the known continuum Schur-complement kinematics quantitatively, while the overall cubic normalization remains a separate question encoded in ${\cal C}_{\mathrm{tail}}$.
...
\textbf{Validated} (76/76 tests passing in the automated suite):
\begin{itemize}
