...
\ie
\propto \delta^{(d-2)}(p + p_1 + p_2)\,  ({\det}' M )^{-\frac{d-2}{2} } \, \exp(-\frac{\A'}{2} J^{i,T} \cdot \wt{M}^{+} \cdot J^i ),
\fe
...
A key test is that this should recover full Lorentz invariance for $d=26$ as $L \to \infty$.
