...
\fe
These counterterms will cancel the divergences in \eqref{largeL}, and the renormalized partition function is simply given by
\ie
Z_\text{r}(\Omega) = \exp c(\Omega).
\fe
The renormalization scheme here is not unique, and one can perform a finite renormalization, namely adding an arbitrary finite part to the counterterms, to define a different renormalization scheme.
...
\subsection{The stress-tensor 1-point function}

\subsection{T-duality}

\subsection{Ratio of compact boson partition functions}
