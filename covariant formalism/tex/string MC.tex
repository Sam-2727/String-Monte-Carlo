...
\fe
where $S_L(\tau)$ is given by:
\ie
S_L(\tau) = \frac{\log |b_1|+\log |b_2|}{36}+\frac{1}{12}\left|\oint_\alpha f(z)dz\right|
\fe
and the term $|\oint_\alpha f(z)dz|$ comes from the fact that we want the flat coordinate to have period 1 around the $\alpha$-cycle.
