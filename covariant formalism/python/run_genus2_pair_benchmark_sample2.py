...
def main():
    ...
    ell_ref = list(4*np.array([48, 40, 44, 44, 48, 40, 44, 44, 44],dtype=int))
    ell_cases = [
        list(4*np.array([30, 28, 44, 44, 60, 28, 44, 44, 74])),
        list(4*np.array([52, 36, 44, 44, 52, 36, 44, 44, 44])),
        list(4*np.array([56, 32, 44, 44, 56, 32, 44, 44, 44])),
        list(4*np.array([60, 28, 44, 44, 60, 28, 44, 44, 44])),
    ]
